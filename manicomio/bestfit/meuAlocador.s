...
alocaMem:
	pushq %rbp                  
  	...
  	movq topoInicialHeap, %rbx # long int *a = ponteiroAtual;
  	movq %rbx, -8(%rbp)
	...
	while2:
		...
		if1:
    		...
    		if2:
				...
				cmpq (%r8), %r10 		
				jge fimif2			#if(a[1] > num_bytes)

				movq (%r8), %r10
				cmpq tamanhoAtual, %r10
				jg fimif2

				movq %r10,tamanhoAtual
				subq $8 ,%r8
				movq %r8, -24(%rbp)
	...
	if2_5:
		...
		movq -24(%rbp),%r8	#rax = a* 
		addq $8, %r8		#rbx = a* + 8 
		movq %r12 , %r10	#r10 = num_bytes 
		addq $16 , %r10		#r10 = numbaytes +16 
		cmpq (%r8), %r10 		
		jge elseif2_5			#if(a[1] > num_bytes + 16)
